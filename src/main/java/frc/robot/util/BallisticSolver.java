...
public class BallisticSolver {
  ...
  public static class ShotSolution {
    ...
    public ShotSolution(double azimuthDeg, double elevationDeg, double power) {
  ...
  private static Double solveTimeNewton(
      double dx, double dy, double dz, double vrx, double vry, double v0, double t0) {
    double t = t0;
  ...
  public static ShotSolution solveShot(
      Pose2d robotPose, Pose3d goalPose, double robotVx, double robotVy) {
