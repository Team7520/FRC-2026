...
public class BallisticSolver {
  ...
  private static double dFdt(
    ...
    double h = 1e-5;
    return (F(t + h, dx, dy, dz, vrx, vry, vrz, v0, g) - F(t - h, dx, dy, dz, vrx, vry, vrz, v0, g))
        / (2 * h);
  }
  ...
  public static ShotSolution solveShot(
    ...
    Double t =
        solveTimeNewton(
            dx, dy, dz, robotVx, robotVy, robotVz, Constants.TurretConstants.launchSpeed, g, 2.0);
    ...
    return new ShotSolution(Math.toDegrees(phi), Math.toDegrees(theta));
  }
}
