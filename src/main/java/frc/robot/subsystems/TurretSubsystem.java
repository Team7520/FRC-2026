...
public class TurretSubsystem extends SubsystemBase {
  ...
  public Rotation2d calculateTurretAngle(Pose2d robotPose, Pose3d goalPose) {
    Translation2d robotToGoal = goalPose.toPose2d().getTranslation().minus(robotPose.getTranslation());
